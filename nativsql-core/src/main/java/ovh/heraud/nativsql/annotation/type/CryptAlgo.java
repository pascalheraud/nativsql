...
/**
 * Specifies the encryption algorithm(s) for an {@code @Encrypted} field.
 *
 * <p>
 * Multiple algorithms = cascade fallback on read: algorithms are tried in order
 ...
 * </pre>
 */
@TypeParam(key = TypeParamKey.ALGO)
