...
class DbOperationLoggerTest {
        ...
        class DebugLoggingTests {
                ...
                void testSameUUIDForAllLogs() {
                        ...
                        dbOperationLogger.execute(DbOperationLoggerTest.class, "SELECT", "users",
                                        "SELECT * FROM users WHERE id = :id", params,
                                        () -> "result");
        ...
        class ErrorLoggingTests {
                ...
                void testExecuteWithNativSQLException() {
                        ...
                        try {
                                dbOperationLogger.execute(DbOperationLoggerTest.class, "DELETE", "users",
                                                "DELETE FROM users",
                                                (SqlCallable<Void>) () -> {
                ...
                void testExecuteWithGenericException() {
                        NativSQLException exception = null;
                        try {
                                dbOperationLogger.execute(DbOperationLoggerTest.class, "UPDATE", "users",
         ...
         */
        private void verifyLogEvent(List<ILoggingEvent> logList, int index, Level expectedLevel,
