...
/**
 * Integration tests for MariaDBContactInfoRepository using Testcontainers.
 */
@Import({ MariaDBUserRepository.class, MariaDBContactInfoRepository.class })
class MariaDBContactInfoRepositoryTest extends MariaDBRepositoryTest {
        @Autowired
        ...
        void testDeleteContactInfo() {
                ...
                List<ContactInfo> deleted = contactInfoRepository.findByUserIdAndType(userId, ContactType.TWITTER,
                                "id");
